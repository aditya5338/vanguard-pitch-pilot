...
# ----------------- APP HEADER -----------------
st.markdown("<div class='main-title'>🏟️ Vanguard Pitch-Pilot</div>", unsafe_allow_html=True)
st.markdown("<div class='subtitle'>FIFA World Cup 2026™ Stadium Operations Command & Dispatch Console</div>", unsafe_allow_html=True)
...
if user_role == "Field Volunteer Input Mode":
    st.markdown("<div class='section-header'>📱 Field Volunteer Input Console</div>", unsafe_allow_html=True)
...
# ----------------- 2. OPERATIONS COMMAND CENTER -----------------
    ...
    st.markdown("<div class='section-header'>🎛️ Operations Command Center</div>", unsafe_allow_html=True)
